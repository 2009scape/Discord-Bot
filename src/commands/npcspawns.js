...
module.exports = {
  ...
  execute     : async (msg, args) => {
    ...
    .promise([
      `SELECT npc_id, name, loc_data AS spawns FROM json('${liveserver_configs_dir}/npc_spawns.json') AS npc_spawns OUTER JOIN json('${liveserver_configs_dir}/npc_configs.json') AS npc_configs ON npc_configs.id = npc_spawns.npc_id WHERE npc_spawns.npc_id = "${npc_id}"`,
    ][0]);
